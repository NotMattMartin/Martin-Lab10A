...
public class Lab10Ast extends Applet
{
    ...
    public static void flagOfHolland (Graphics g)
    {
        ...
        for (int d = 1; d <= numDots; d++)
        {
            ...
            if (y >= 216 && y < 433)           // middle stripe requires compound condition
                Expo.setColor(g,Expo.white);

            if (y >= 433)                      // bottom stripe
                Expo.setColor(g,Expo.blue);
     ...
     public static void flagOfBariya (Graphics g)
    {
        ...
        for (int d = 1; d <= numDots; d++)
        {
            ...
            if (y >= 162 && y < 325)           // top stripe requires compound condition
                Expo.setColor(g,Expo.white);
                
            if (y >= 325 && y < 489)           // bottom stripe requires compound condition
                Expo.setColor(g,Expo.red);

            if (y >= 489)                      // bottom stripe
                Expo.setColor(g,Expo.white);
     ...
     public static void flagOfMauritius (Graphics g)
    {
     ...
     public static void flagOfNaval (Graphics g)
    {
        Expo.setBackground(g,Expo.purple);
        for (int d = 1; d <= numDots; d++)
        {
     ...
     public static void flagOfNaval2 (Graphics g)
    {
        Expo.setBackground(g,Expo.purple);
        for (int d = 1; d <= numDots; d++)
        {
            ...
            if (y >= 130 && y < 260)           // top middle requires compound condition
                Expo.setColor(g,Expo.white);
                
            if (y >= 260 && y < 390)           // middle requires compound condition
                Expo.setColor(g,Expo.darkBlue);

            if (y >= 390 && y < 520)           // bottom middle requires compound condition
                Expo.setColor(g,Expo.darkBlue);
